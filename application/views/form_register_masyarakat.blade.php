...
<div class="row">
    ...
    <div class="col-lg-6 mx-auto">
        <div class="card">
            <div class="card-body">
                <form action="{{ base_url($action) }}" method="post" data-parsley-validate>
                        <div class="row row-sm">
                            ...
                            <div class="col-lg-3 col-12 mt-3">
                                ...
                                @endif
                                <button type="submit" class="btn btn-primary btn-block text-capitalize">{{ $btn }}</button>
                            </div>
                            @if ($masyarakat)
                            <div class="col-lg-3 col-12 mt-3">
                            <a href="{{ base_url('info') }}" class="btn btn-success btn-sm" >Kembali</a>
                            </div>
                            @endif
                        </div>
