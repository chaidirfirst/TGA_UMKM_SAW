...
<head>
    ...
    <link href="{{ base_url('assets/') }}lib/datatables.net-responsive-dt/css/responsive.dataTables.min.css"
        rel="stylesheet">
...
<body class="az-body az-dashboard-eight">
    ...
    <div id="setting" class="modal">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <form id="selectForm2" class="parsley-style-1" method="POST"
                    action="{{ base_url('sistem/change_password') }}" data-parsley-validate>
    ...
    @php
        ...
        if ($CI->session->flashdata('pesan')) {
            echo '<script>'.$CI->session->flashdata('pesan').'</script>';
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var date = $(this).val();
            var tahun_lahir= date.substr(0,4);
